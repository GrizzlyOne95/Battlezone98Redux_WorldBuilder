...
from hg2_codec import DEFAULT_ZONE_BITS, read_hg2_header
from legacy_palette import resolve_legacy_palette, scan_trn_palette_references
from maketrn_compat import METERS_PER_ZONE, read_legacy_trn_zone_geometry
from mission_visualizer import extract_terrain_name
